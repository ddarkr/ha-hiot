...
> [!NOTE]  
> 기기가 정상적으로 추가되지 않는 경우, [HT HomeService 웹 사이트](https://www2.hthomeservice.com/)에 로그인 후 기기가 정상적으로 표시/제어되는지 확인해주세요. 웹 사이트의 API를 사용하기 때문에 웹 사이트가 정상적으로 동작하지 않는 경우, 이 통합구성요소도 정상적으로 동작하지 않습니다.
...
또한, 본 프로젝트는 HT와 연관되어 있지 않습니다. 사용으로 인해 발생하는 모든 책임은 사용자에게 있습니다.
